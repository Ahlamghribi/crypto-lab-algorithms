...
if __name__ == '__main__':
    ...
    # Clé et texte à chiffrer (exemple standard)
    key = bytes.fromhex('2b7e151628aed2a6abf7158809cf4f3c')  # Clé AES 128 bits
    plaintext = bytes.fromhex('3243f6a8885a308d313198a2e0370734')  # Exemple de texte clair 128 bits
    ...
    print(f"Déchiffré : {decrypted.hex()}")

    # Vérification du bon fonctionnement
    if decrypted == plaintext:
        print("\nLe test a réussi, le texte déchiffré correspond au texte original.")
    else:
        print("\nLe test a échoué, le texte déchiffré ne correspond pas au texte original.")
